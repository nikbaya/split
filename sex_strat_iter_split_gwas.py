...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 16 15:51:20 2019

Sex-stratified random split GWAS
...
#phens_ls = ['50','20160','30100','2443','23107']
phens_ls = ['1757']
...
for phen_i in idx_ls:
    ...
    #            sumstats_template.show()
            ...
            metaA_path = output_bucket+phen+'_'+sex+'_A_nchunks'+str(n_chunks)+'_batch'+str(batch)+'_split.tsv.bgz' 
            metaB_path = output_bucket+phen+'_'+sex+'_B_nchunks'+str(n_chunks)+'_batch'+str(batch)+'_split.tsv.bgz' 
        ...
        print('\n####################')
        print('Finished '+sex+' phen '+phen+' ('+str(phen_i+1)+' of '+str(len(phens_ls))+')')
